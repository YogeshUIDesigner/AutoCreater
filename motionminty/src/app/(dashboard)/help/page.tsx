export default function HelpPage() {
  const faqs = [
    { q: 'How does the automation work?', a: 'Once you enable automation, MotionMint-y runs a pipeline every day: it researches trending topics in your niche, generates scripts, creates voiceovers, renders videos, makes carousels, generates shorts, and publishes everything to your connected platforms automatically.' },
    ...
    { q: 'How do I connect my YouTube channel?', a: 'Go to Channels → Click "Connect YouTube" → Sign in with your Google account → Authorize MotionMint-y. We use OAuth 2.0 and never store your password.' },
    ...
    <div style={{ maxWidth: 800, display: 'flex', flexDirection: 'column', gap: 24, animation: 'fadeIn 0.4s ease' }}>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill,minmax(200px,1fr))', gap: 12 }}>
        {[
          ...
          { icon: '📧', title: 'Email Support', desc: 'support@motionminty.ai' },
        ].map((r, i) => (
